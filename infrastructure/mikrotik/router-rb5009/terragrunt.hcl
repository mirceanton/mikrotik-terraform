...
inputs = {
  ...
  ethernet_interfaces = {
    ...
    "ether2" = { comment = "Living Room", tagged = local.shared_locals.all_vlans }
    "ether3" = { comment = "Sploinkhole", untagged = local.shared_locals.vlans.Trusted.name }
    "ether4" = {}
    "ether5" = {}
    "ether6" = {}
    "ether7" = {}
    "ether8" = {
      ...
      tagged   = [local.shared_locals.vlans.Untrusted.name, local.shared_locals.vlans.Guest.name, local.shared_locals.vlans.IoT.name]
    }
    "sfp-sfpplus1" = {}
  }
}
