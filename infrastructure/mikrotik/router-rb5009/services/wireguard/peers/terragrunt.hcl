...
terraform {
  source = "git::https://github.com/mirceanton/terraform-modules-routeros.git//modules/wireguard-peers?ref=v0.4.0"
}
...
inputs = {
  ...
  peers = {
    ...
    "anaphone"   = { allowed_address = ["172.16.69.19/32"], comment = "Ana Phone" }
  }
}
